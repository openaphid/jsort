...
//line sort_slice_dps_test.go2:12
type Person struct {
	Age  int
	name string
}
...
func TestByAge(t *testing.T) {
	for i := 1; i <= 1024*10; i++ {
						...
						prepare(persons)
//line sort_slice_dps_test.go2:38
  instantiate୦୦Sort୦sort_slice_dps୮aPerson(persons, byAge)

//line sort_slice_dps_test.go2:42
...
//line sort_slice_dps_test.go2:103
   }
		})
