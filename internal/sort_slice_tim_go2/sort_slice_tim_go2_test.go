...
//line sort_slice_tim_go2_test.go2:1
package sort_slice_tim_go2

//line sort_slice_tim_go2_test.go2:1
import (
//line sort_slice_tim_go2_test.go2:7
 builtinsort "sort"
//line sort_slice_tim_go2_test.go2:7
 "fmt"
//line sort_slice_tim_go2_test.go2:7
...
//line sort_slice_tim_go2_test.go2:12
type Person struct {
	Age  int
	name string
}
...
func TestByAge(t *testing.T) {
	for i := 1; i <= 1024*10; i++ {
						...
						prepare(persons)
//line sort_slice_tim_go2_test.go2:38
  instantiate୦୦Sort୦sort_slice_tim_go2୮aPerson(persons, byAge)

//line sort_slice_tim_go2_test.go2:42
	...
	for _, size := range benchmarkSizes {
		...
		t.Run(fmt.Sprintf("TimSort-%d", size), func(t *testing.B) {
			for i := 0; i < t.N; i++ {
								...
								copy(dup, data)
								t.StartTimer()
//line sort_slice_tim_go2_test.go2:62
    instantiate୦୦Sort୦sort_slice_tim_go2୮aPerson(dup, byAge)
//line sort_slice_tim_go2_test.go2:64
   }
		})
	...
	for _, size := range benchmarkSizes {
		...
		t.Run(fmt.Sprintf("TimSort-%d", size), func(t *testing.B) {
			for i := 0; i < t.N; i++ {
								...
								copy(dup, data)
								t.StartTimer()
//line sort_slice_tim_go2_test.go2:109
    instantiate୦୦Sort୦int(dup, func(i, j int) int { return i - j })
//line sort_slice_tim_go2_test.go2:111
   }
		})
