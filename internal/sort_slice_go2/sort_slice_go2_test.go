      ...
      return o1 - o2
			...
			t.Run(fmt.Sprintf("TimSort-Go2-%s-%d", name, size), func(t *testing.B) {
				for i := 0; i < t.N; i++ {
									...
									t.StartTimer()
//line sort_slice_go2_test.go2:158
     instantiate୦୦Timsort୦int(dup, func(o1, o2 int) int {
//line sort_slice_go2_test.go2:160
      return o1 - o2
					})
				}
			})
